        ...
        <div className="section1">
          <div className="col1">
            ...
            <div className="txt2">
              ...
              <p>Strengthening relationships and communication.</p>
            </div>
            <div className="txt3">
            ...
            <div className="txt4">
              ...
              <p>Collaborative sessions to foster growth and support.</p>
            </div>
            <div className="txt5">
              <h1>Workshops & Seminars</h1>
              <p>
                Engaging programs on various topics related to mental health,
